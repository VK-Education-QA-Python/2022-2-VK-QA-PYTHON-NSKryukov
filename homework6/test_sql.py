...
class TestMysql:
    ...
    def test_most_frequent_requests(self, lines_amount=10):
        ...
        assert len(self.client.get_most_frequent_requests()) == lines_amount
    ...
    def test_highest_request_with_4xx_code(self, lines_amount=5):
        ...
        assert len(self.client.get_highest_request_with_4xx_code()) == lines_amount
    ...
    def test_most_frequent_users(self, lines_amount=5):
        ...
        assert len(self.client.get_most_frequent_users_with_5xx_code()) == lines_amount
